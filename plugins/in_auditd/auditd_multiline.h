...
#ifndef FLB_AUDITD_MULT_H
#define FLB_AUDITD_MULT_H
...
#define FLB_AUDITD_MULT_NA    -1   /* not applicable as a multiline stream */
#define FLB_AUDITD_MULT_DONE   0   /* finished a multiline stream */
#define FLB_AUDITD_MULT_MORE   1   /* expect more lines to come   */
#define FLB_AUDITD_MULT_FLUSH  4   /* max flush time for multiline */

struct flb_auditd_mult {
...
int flb_auditd_mult_flush(msgpack_sbuffer *mp_sbuf,
