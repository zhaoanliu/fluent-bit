...
#ifndef FLB_AUDITD_SQL_H
#define FLB_AUDITD_SQL_H
 ...
 *
 * in_auditd plugin table to track files: in_auditd_files
 */
#define SQL_CREATE_FILES                                                \
    "CREATE TABLE IF NOT EXISTS in_auditd_files ("                        \
...
#define SQL_GET_FILE "SELECT * from in_auditd_files WHERE name='%s'"  \
    " AND inode=%"PRIu64";"

#define SQL_INSERT_FILE                                             \
    "INSERT INTO in_auditd_files (name, offset, inode, created)"      \
    "  VALUES ('%s', %"PRIu64", %"PRIu64", %"PRIu64");"

#define SQL_UPDATE_OFFSET                               \
    "UPDATE in_auditd_files set offset=%"PRIu64" WHERE id=%"PRId64";"

#define SQL_ROTATE_FILE                         \
    "UPDATE in_auditd_files set name='%s',rotated=1 WHERE id=%"PRId64";"
